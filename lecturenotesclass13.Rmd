...
- Sample: Mice died while untreated
- Sample size: 261
...
In comparison to the 95% confidence interval. the visualization shows that the 90% confidence interval includes less total values within data set. This is the give and take that using a higher/lower confidence interval requires. 
